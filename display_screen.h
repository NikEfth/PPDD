...
public:
    ...
    void set_Viridis()
    {
        ...
        background = _data[0];
        _data[0] = QColor( (quint8)(_viridis_data[0][0]*255),
                (quint8)(_viridis_data[0][1]*255),
                 (quint8)(_viridis_data[0][2]*255));
        _data[255] = QColor( (quint8)(_viridis_data[255][0]*255),
                (quint8)(_viridis_data[255][1]*255),
                 (quint8)(_viridis_data[255][2]*255));

        setColorInterval(_data[0], _data[255]);
        for (int i=1; i < 255; i++, cur+=step)
        {
            _data[i] = QColor(    (quint8)(_viridis_data[i][0]*255),
                        (quint8)(_viridis_data[i][1]*255),
                        (quint8)(_viridis_data[i][2]*255));
            addColorStop(cur,_data[i]);

        }
    }

    inline QColor get_background()
    { return background; }
private:
    QColor background;
    QColor _data[256];
